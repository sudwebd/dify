const translation = {
  ...
  welcome: '👋 Welcome to CalybAI Agent Studio, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting CalybAI Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on CalybAI',
  invalid: 'The link has expired',
  explore: 'Explore CalybAI',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on CalybAI and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The CalybAI Enterprise license for your workspace has expired. Please contact your administrator to continue using CalybAI.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect CalybAI license server. Please contact your administrator to continue using CalybAI.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The CalybAI Enterprise license for your workspace is inactive. Please contact your administrator to continue using CalybAI.',
  webapp: {
    login: 'Login',
