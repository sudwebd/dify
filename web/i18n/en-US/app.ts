const translation = {
  ...
  tracing: {
    ...
    aliyun: {
      title: 'Cloud Monitor',
      description: 'The fully-managed and maintenance-free observability platform provided by Alibaba Cloud, enables out-of-the-box monitoring, tracing, and evaluation of CalybAI applications.',
    },
    inUse: 'In use',
    configProvider: {
      title: 'Config ',
