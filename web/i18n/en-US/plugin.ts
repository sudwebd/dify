const translation = {
  ...
  marketplace: {
    ...
    discover: 'Discover',
    and: 'and',
    difyMarketplace: 'CalybAI Marketplace',
    ...
    viewMore: 'View more',
    verifiedTip: 'Verified by CalybAI',
    partnerTip: 'Verified by a CalybAI partner',
  },
  task: {
  ...
  difyVersionNotCompatible: 'The current CalybAI version is not compatible with this plugin, please upgrade to the minimum version required: {{minimalDifyVersion}}',
  auth: {
    default: 'Default',
    custom: 'Custom',
