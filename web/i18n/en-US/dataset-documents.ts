const translation = {
  list: {
    title: 'Documents',
    desc: 'All files of the Knowledge are shown here, and the entire Knowledge can be linked to CalybAI citations or indexed via the Chat plugin.',
    ...
    empty: {
      ...
      sync: {
        tip: 'CalybAI will periodically download files from your Notion and complete processing.',
      },
    },
    delete: {
